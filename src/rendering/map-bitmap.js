...
function baseElev(col, row) {
  ...
  // 关中平原
  if (col >= 3 && col <= 8 && row >= 7.2 && row <= 8.8) return 28;
  // 黄土高原
...
// ============================================================
//  河流——调准走向
//  黄河"几"字弯：源出青海→向北到河套→向南到潼关→向东入海
//  长江：出四川盆地→穿三峡→过江陵襄阳→经扬州入海
// ============================================================
function paintRivers(ctx) {
  const yellow = [
    { x: 180, y: 360 },   // 源头（青海，col≈2.5,row≈5.3）
    { x: 260, y: 330 },   // 向北
    { x: 310, y: 270 },   // 河套（最北端）
    { x: 380, y: 290 },
    { x: 440, y: 360 },   // 向南拐
    { x: 500, y: 450 },
    { x: 540, y: 530 },   // 潼关附近（col≈7.5,row≈8）
    { x: 620, y: 610 },
    { x: 780, y: 580 },   // 洛阳（col≈11,row≈8.5）
    { x: 950, y: 600 },
    { x: 1100, y: 640 },  // 汴州（col≈15,row≈9.5）
    { x: 1300, y: 630 },
    { x: 1550, y: 560 },
    { x: 1800, y: 480 },
    { x: 2050, y: 430 },
  ...
  const yangtze = [
    ...
    { x: 320, y: 1050 },  // 四川盆地南缘
    { x: 440, y: 1080 },
    { x: 560, y: 1090 },  // 三峡（col≈8,row≈16.3）
    { x: 700, y: 1110 },
    { x: 840, y: 1120 },  // 江陵（col≈11.5,row≈16.8）
    { x: 980, y: 1130 },
    { x: 1100, y: 1120 }, // 襄阳（col≈14.5,row≈16.8）
    { x: 1250, y: 1110 },
    { x: 1450, y: 1130 },
    { x: 1650, y: 1150 }, // 扬州（col≈21.5,row≈17.2）
    { x: 1850, y: 1180 },
    { x: 2100, y: 1200 },
    { x: 2350, y: 1210 },
    { x: 2395, y: 1215 }, // 入海
  ...
  const minjiang = [
    { x: 80, y: 970 }, { x: 140, y: 995 }, { x: 190, y: 1020 }, { x: 230, y: 1035 },
  ];
  const hanjiang = [
    { x: 440, y: 840 }, { x: 560, y: 890 }, { x: 680, y: 950 },
    { x: 780, y: 1020 }, { x: 860, y: 1080 }, { x: 930, y: 1125 },
  ];
...
function paintLabels(ctx) {
  ...
  const rivers = [
    { t: '黄  河', x: 1050, y: 620, a: -0.02 },
    { t: '长  江', x: 1160, y: 1145, a: 0.02 },
    { t: '岷  江', x: 180, y: 1010, a: 0.3, sz: 22 },
    { t: '汉  江', x: 710, y: 990, a: 0.35, sz: 22 },
  ];
