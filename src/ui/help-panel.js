...
function getPanel() {
  ...
  panelEl.style.cssText = `
    ...
    border-radius:8px; padding:22px; color:#ddd;
...
export function showHelpPanel() {
  ...
  panel.innerHTML = `
    <h2 style="color:#ccaa44;margin:0 0 12px;border-bottom:1px solid #665522;padding-bottom:10px">📖 唐末风云 · 游戏说明</h2>

    <h3 style="color:#ccaa44;font-size:15px">🎯 游戏目标</h3>
    <p style="font-size:13px;color:#bbb;margin:4px 0 12px">
      唐末天下大乱，群雄割据。选择一方势力，发展城池、招募军队、
      征战四方，最终统一天下。
    </p>

    <h3 style="color:#ccaa44;font-size:15px">🏙️ 城池经营</h3>
    <p style="font-size:13px;color:#bbb;margin:4px 0 12px">
      点击城池可打开内政面板：<br>
    ...
    <h3 style="color:#ccaa44;font-size:15px">⚔️ 兵种克制</h3>
    <p style="font-size:13px;color:#bbb;margin:4px 0 12px">
      🛡️ 步兵克 🐎 骑兵 → 🐎 骑兵克 🏹 弓兵 → 🏹 弓兵克 🛡️ 步兵<br>
      克制方攻击力 +50%，善用克制可扭转战局。
    </p>

    <h3 style="color:#ccaa44;font-size:15px">🗺️ 部队移动</h3>
    <p style="font-size:13px;color:#bbb;margin:4px 0 12px">
      点击部队可查看详情。行军速度取决于兵种——骑兵最快、弓兵次之、步兵最慢。
      两支敌对部队相遇时自动触发战斗。
    </p>

    <h3 style="color:#ccaa44;font-size:15px">🤝 外交</h3>
    <p style="font-size:13px;color:#bbb;margin:4px 0 12px">
    ...
    <h3 style="color:#ccaa44;font-size:15px">🔄 回合制</h3>
    <p style="font-size:13px;color:#bbb;margin:4px 0 12px">
    ...
    <h3 style="color:#ccaa44;font-size:15px">👤 武将属性</h3>
    <p style="font-size:13px;color:#bbb;margin:4px 0 12px">
    ...
    <h3 style="color:#ccaa44;font-size:15px">💾 存档</h3>
    <p style="font-size:13px;color:#bbb;margin:4px 0 12px">
      5个存档位。每回合结束自动存档到第1位。
      点击右下角"存档"按钮可手动保存/读取/删除存档。
    </p>

    <div style="margin-top:16px;text-align:right;border-top:1px solid #665522;padding-top:10px">
      <button id="btn-help-close" style="
        padding:6px 28px;background:#443322;color:#ccaa44;border:1px solid #665522;
